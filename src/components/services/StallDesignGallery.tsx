...
const StallDesignGallery: React.FC = () => {
  const [selectedImageIndex, setSelectedImageIndex] = useState<number | null>(null);
  const [isPopupOpen, setIsPopupOpen] = useState(false);
  
  const images = getDisplayImages('Stall Design & Fabrication' as MainCategory);
  ...
  return (
    <div className="py-10 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-bold text-center mb-8">Stall Design & Fabrication Gallery</h2>
        
        <GalleryGrid
          images={[...images]}
          activeTab="Stall Design & Fabrication"
...
export default StallDesignGallery;
